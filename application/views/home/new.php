            ...
            <div class="container-fluid">
                <div class="row justify-content-center align-items-center" style="margin-top:100px; border:1px;">
                    <div class="form-req col-md-6 col-sm-6 col-xs-12">
                        <h3 style="text-align: center;">Buat Jadwal Bimbingan</h3>
                        <h5 style="text-align: center;">Pilihan Jenis Bimbingan : </h5>
                        <div class="row justify-content-center align-items-center">
                            <a href="<?= base_url('home/newmassal'); ?>"><button style="width: 300px; height:50px; margin-bottom:40px;">Massal</button></a>
                        </div>
                        <div class="row justify-content-center align-items-center">
                            <a href="<?= base_url('home/newindividu'); ?>"><button style="width: 300px; height:50px; margin-bottom:40px;">Individu</button></a>
                        </div>

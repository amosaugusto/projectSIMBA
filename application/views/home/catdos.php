            ...
            <div class="container-fluid">
                <div class="row justify-content-center align-items-center" style="margin-top:100px; border:1px;">
                    <div class="form-req col-md-6 col-sm-6 col-xs-12">
                        ...
                        <form action="<?= base_url('home/tambahcatat'); ?>" method="post">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Topik yang dibahas</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="topik" placeholder="Topik">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Feedback Dosen</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="mahasiswa" placeholder="Mahasiswa">
                                </div>
                            </div>
